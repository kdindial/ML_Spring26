...
I "scored" the model by calculating the difference for each star in the model and the validation data and squared that difference. 
\begin{equation}
    Err=\sum (y-f(x))^2
\end{equation}
I then summed up the errors squared for each point in the validation set and used that sum. My code, and this writeup are in my github repository.
